...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, OccurrenceDTO> jsonConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OccurrenceDTO> jsonKafkaListenerContainerFactory() {
